...
Um exmemplo prático de ambos os casos seria o uso de uma fórmula matemática. O cálculo da área do círculo é dado por pi vezes o raio ao quadrado, divido por dois. O pi é o valor constante da fórmula, ele jamais vai mudar. Enquanto que o raio é a variável, onde a cada execução ele poderá ter um valor difernte.
...
- elas devem começar por um caractere alfanumérico;
